...
function _getOrAddDistribution (event: DistributionAdded | DistributionClaimed): Distribution {
...
export function handleDistributionClaimed(event: DistributionClaimed): void {
  let distribution = _getOrAddDistribution(event);
